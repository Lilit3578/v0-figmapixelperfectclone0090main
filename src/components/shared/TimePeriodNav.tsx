  ...
  return (
    <div className="flex-col justify-start items-start flex self-stretch">
      {periods.map((period) => (
        <div
          key={period.id}
          className={`self-stretch px-4 py-2 overflow-hidden rounded cursor-pointer flex justify-start items-center gap-2 ${
        ...
        >
          <div 
            className="flex-1 text-[#1F1F1F] text-sm font-normal"
            style={{ 
