      ...
      <div className="w-full max-w-md bg-white rounded-lg border p-6">
        ...
        {activeTab === 'signin' && (
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <Button variant="primary" className="w-full" disabled={isLoading} onClick={handleSignIn}>
        ...
        {activeTab === 'signup' && (
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <Button variant="primary" className="w-full" disabled={isLoading} onClick={handleSignUp}>
