...
export const InsightsPage: React.FC<InsightsPageProps> = ({ selectedPeriod, selectedProject }) => {
  ...
  const memoizedInsightsTabs = useMemo(
    () => (
      <InsightsTabs activeTab={activeInsightTab} onTabChange={setActiveInsightTab} sprints={filteredSprints} period={selectedPeriod} selectedProject={selectedProject} projects={projects} />
    ),
